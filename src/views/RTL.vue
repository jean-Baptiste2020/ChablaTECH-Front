        ...
        <a-card :bordered="false" class="card-info-2 mb-24 h-full">
          ...
          >
            <div class="card-content">
              <h5>Faites ici la commande d'un projet web</h5>
              <p v-if="commandeB">
                Il suffit de cliquez sur "Lire Plus" puis remplir tous les
                champs disponibles concernant votre projet.
              </p>
            </div>
            <div class="card-content" v-if="commande">
              <p>
                <Upload
                  multiple
                  type="drag"
                ...
                >
                  <div style="padding: 20px 0">
                    ...
                    ></Icon>
                    <p style="color: black">
                      Cliquez ou faites glisser le cahier de charge, des images
                      et même logo que vous aimeriez qu'on utilises ici pour
                      télécharger
                    </p>
                  </div>
                </Upload>
              ...
              <p>
                <Input
                  v-model="value15"
                  type="number"
                  placeholder="Entrez le montant de votre Budget en FCFA"
                />
              </p>
              <p>
                <DatePicker
                  type="date"
                  placeholder="Format: Année-mois-jour"
                  style="width: 100%"
                ></DatePicker>
              </p>
              <p>
                <Input
                  v-model="value15"
                  type="url"
                  placeholder="Un lien d'un de vos sites web si possible"
                />
              </p>
              <Button
                type="success"
              ...
              <Button
                ...
                @click="commandeAnnuler"
                >Annuler</Button
              >
            </div>

            <div class="card-footer">
              <a href="#" size="small" @click="commander" v-if="commandeB">
                <span>Lire Plus</span>
                <svg
                  width="16"
                  height="16"
...
<script>
//popup anim
import Pop from "../components/animations/popup.vue";
...
export default {
  ...
  data() {
    return {
      ...
      //Variables de commandes de projet
      commande: false,
      commandeB: true,
    };
  },
  ...
  methods: {
    ...
    commandeValider() {
      this.i(
        "Votre projet sera analyser puis nous vous ferons signe au plus dans 5 heure par rapport au montant...☻"
      );
      this.commande = false;
      this.commandeB = true;
    },
