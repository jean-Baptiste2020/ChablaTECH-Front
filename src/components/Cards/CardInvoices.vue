<template>
  ...
  >
    <template #title>
      <h6 class="font-semibold m-0">Factures</h6>
    </template>
    <template slot="extra" class="mb-0">
      <a-button type="primary"> VOIR TOUT </a-button>
    </template>
    <a-list
      class="invoice-list"
    ...
    <a-modal v-model="visible" title="Basic Modal" @ok="handleOk">
      <Card style="width: 320px" id="recu">
        <div style="text-align: center">
          <img alt="Logo ici" />
          <h3>Cette récente facture a pour code B256970</h3>
        </div>
      </Card>
    </a-modal>
  </a-card>
...
export default {
  ...
  methods: {
    ...
    handleOk(e) {
      ...
      doc.html(document.querySelector("#recu"), {
        callback: function (pdf) {
          pdf.save("code.pdf");
        },
      });
      this.i("Télecharger le code pour tout reclamation");
      this.visible = false;
    },
  },
};
