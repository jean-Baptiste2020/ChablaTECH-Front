  ...
  >
    ...
    <div class="drawer-content">
      ...
      <div class="sidebar-color">
        <h6>Couleur de la barre latérale</h6>
        <a-radio-group
      ...
      <div class="sidenav-type">
        <h6>Type Menu</h6>
        <p>Choisissez entre 2 types de Menu différents.</p>
        <a-radio-group
          button-style="solid"
        ...
        >
          ...
          <a-radio-button value="white">BLANC</a-radio-button>
        </a-radio-group>
      </div>
      <div class="navbar-fixed">
        <h6>Barre de navigation fixe</h6>
        <a-switch
          default-checked
