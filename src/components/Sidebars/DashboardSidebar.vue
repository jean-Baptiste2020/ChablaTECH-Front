  ...
  >
    <div class="brand">
      <a href="/" style="text-decoration: none"
        ><img src="assets/img/logo.png" alt="" /> <span>ChablaTech</span></a
      >
    </div>
    <hr />
    ...
    <a-menu theme="light" mode="inline">
      ...
      <a-menu-item>
        <router-link to="/parainage">
          <span class="icon">
            <a-icon type="container" theme="outlined" />
          </span>
          <span class="label">Bon de Parrainage</span>
        </router-link>
      </a-menu-item>
      <a-menu-item>
        <router-link to="/test">
          ...
          <span class="label">Passez le Test</span>
        </router-link>
      </a-menu-item>
      <a-menu-item class="menu-item-header"> Pages de compte </a-menu-item>
      <a-menu-item>
    ...
    <div class="aside-footer">
      <div class="footer-box">
        ...
        <h6>Besoin d'aide?</h6>
        <p>Veuillez consulter notre robot</p>
