    ...
    <a-layout-header>
      <a-row type="flex">
        ...
        <a-col :span="24" :md="6">
          ...
          <Breadcrumb>
            <BreadcrumbItem to="/">
              <Icon type="ios-home-outline"></Icon> Acceuil
            </BreadcrumbItem>
            <BreadcrumbItem to="/components/breadcrumb">
              <Icon type="logo-buffer"></Icon> {{ this.$route.name }}
            </BreadcrumbItem>
          </Breadcrumb>
          <!-- / Header Breadcrumbs -->
          ...
          <div class="ant-page-header-heading">
            <span class="ant-page-header-heading-title"
              ><Icon type="ios-cafe"></Icon>{{ this.$route.name }}</span
            >
          </div>
          <!-- / Header Page Title -->
        </a-col>
...
export default {
  ...
  data() {
    return {
      ...
      //Les variables de search
      value3: "",
      data3: ["Facturation", "Passer le test", "News"],
    };
  },
  methods: {
    resizeEventHandler() {
